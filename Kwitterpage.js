  ...
  function getData() { 
    ...
    snapshot.forEach(function(childSnapshot) { childKey = childSnapshot.key; 
        ...
        if(childKey != "purpose") { 
            ...
            texto = "<h4>" + message + "</h4>";
            botao = "<button onclick= 'like(this.id)' class= 'btn btn-warning' id= "+firebase_message_id+" value= "+like+" <span class= 'glyphcon glyphcon-thumbs-up'>like: "+like+"</span> </button>"; 
